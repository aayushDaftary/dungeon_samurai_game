...
#define LEVELB_HEIGHT 25
//#define ENEMY_COUNT_B 3
#define ITEM_COUNT_B 6

unsigned int LEVELB_DATA[] =
{
    3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
    7, 6, 6, 6, 6, 6, 6, 6, 5, 6, 6, 6, 5, 6, 6, 5, 6, 6, 3, 6, 6, 5, 6, 6, 7,
    7, 6, 6, 6, 6, 6, 5, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 3, 6, 6, 6, 6, 6, 7,
    7, 6, 6, 6, 6, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 6, 6, 5, 6, 6, 7,
    7, 5, 6, 6, 6, 6, 6, 5, 6, 6, 6, 5, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 7,
    7, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 5, 6, 7,
    7, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 5, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 7,
    7, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 5, 6, 6, 6, 6, 6, 6, 6, 6, 6, 7,
    7, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 5, 6, 6, 6, 6, 6, 6, 6, 6, 7,
    7, 6, 6, 5, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 7,
    7, 6, 6, 6, 6, 6, 6, 6, 5, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 7,
    7, 5, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 5, 6, 6, 6, 6, 6, 6, 6, 6, 6, 7,
    7, 6, 6, 6, 5, 6, 6, 6, 6, 6, 6, 6, 5, 5, 5, 5, 5, 5, 6, 6, 5, 5, 5, 5, 7,
    7, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 5, 3, 3, 3, 3, 3, 6, 6, 3, 3, 3, 3, 7,
    7, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 5, 7, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 7,
    7, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 5, 7, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 7,
    7, 6, 3, 3, 8, 8, 3, 3, 6, 6, 6, 6, 5, 7, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 7,
    7, 6, 7, 8, 8, 8, 8, 7, 6, 6, 6, 6, 5, 7, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 7,
    7, 6, 7, 8, 8, 8, 8, 7, 6, 6, 5, 6, 6, 6, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 7,
    7, 6, 7, 8, 8, 8, 8, 7, 6, 6, 6, 6, 6, 6, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 7,
    7, 6, 7, 8, 8, 8, 8, 7, 6, 6, 6, 6, 5, 7, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 7,
    7, 6, 7, 8, 8, 8, 8, 7, 6, 6, 6, 6, 5, 7, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 7,
    7, 6, 3, 3, 3, 3, 3, 3, 6, 6, 6, 6, 5, 7, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 7,
    7, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 5, 7, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 7,
    3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
};
...
void LevelB::initialise(int lives) {
    ...
    m_game_state.map = new Map(LEVELB_WIDTH, LEVELB_HEIGHT, LEVELB_DATA,grass_tex, 1.0f,8,15);
    ...
    //m_game_state.player->boss_hit_texture_id = Utility::load_texture("boss_hit.png");
    ...
    GLuint boss_hit_texture_id = Utility::load_texture("boss_hit.png");
    ...
    m_game_state.enemies[2].m_texture_id = enemy1_texture_id;
    m_game_state.enemies[2].set_position(glm::vec3(13.0f, -18.5f, 0.0f));
    ...
    m_game_state.enemies[2].m_health = 20;
    m_game_state.enemies[2].m_damage = 10;
    ...
    m_game_state.enemies[3].m_texture_id = enemy1_texture_id;
    m_game_state.enemies[3].set_position(glm::vec3(19.0f, -12.0f, 0.0f));
    ...
    m_game_state.enemies[3].m_health = 20;
    m_game_state.enemies[3].m_damage = 10;
    ...
    m_game_state.enemies[4].m_texture_id = enemy_texture_id;
    m_game_state.enemies[4].set_position(glm::vec3(8.0f, -2.0f, 0.0f));
    ...
    m_game_state.enemies[4].m_health = 20;
    m_game_state.enemies[4].m_damage = 10;
    ...
    m_game_state.enemies[5].m_texture_id = sneaky_snake_texture_id;
    m_game_state.enemies[5].set_position(glm::vec3(23.0f, -2.0f, 0.0f));
    ...
    m_game_state.enemies[5].m_health = 20;
    m_game_state.enemies[5].m_damage = 10;
    ...
    m_game_state.enemies[6].set_position(glm::vec3(3.25f, -17.0f, 0.0f));
    ...
    m_game_state.enemies[6].m_health = 20;
    m_game_state.enemies[6].m_damage = 10;
    ...
    m_game_state.enemies[7].set_position(glm::vec3(6.25f, -17.0f, 0.0f));
    ...
    m_game_state.enemies[7].m_health = 20;
    m_game_state.enemies[7].m_damage = 10;
    ...
    m_game_state.enemies[8].m_animation_cols = 5;
    m_game_state.enemies[8].m_animation_rows = 1;
    m_game_state.enemies[8].m_animation_frames = 5;
    m_game_state.enemies[8].m_animation_indices = new int[5]{ 0, 1, 2, 3, 5};
    ...
    m_game_state.enemies[8].set_position(glm::vec3(20.0f, -17.0f, 0.0f));
    ...
    //boss getting hit
    Entity& boss = m_game_state.enemies[8];
    boss.boss_hit_texture_id = boss_hit_texture_id;
    boss.m_hit_animation_cols = 3;
    boss.m_hit_animation_rows = 1;
    boss.m_hit_animation_frames = 3;
    boss.m_hit_animation_indices = new int[3]{ 0, 1, 2 };

    // items
    m_number_of_items = ITEM_COUNT_B;
    m_game_state.items = new Entity[ITEM_COUNT_B];
    ...
    m_game_state.items[0].set_position(glm::vec3(4.75f, -21.0f, 0.0f));
    ...
    m_game_state.items[1].set_position(glm::vec3(23.0f, -2.0f, 0.0f));
...
//    m_game_state.items[2].set_position(glm::vec3(4.75f, -21.0f, 0.0f));
...
void LevelB::update(float delta_time)
{
    ...
    unsigned int tile = 0;
    if (tile_x >= 0 && tile_x < LEVELB_WIDTH && tile_y >= 0 && tile_y < LEVELB_HEIGHT)
    {
        tile = m_game_state.map->get_level_data()[tile_y * LEVELB_WIDTH + tile_x];
    }
    ...
    if (boss_defeated && !door_spawned)
    {
        ...
        door->set_position(glm::vec3(17.0f, -17.0f, 0.0f));
